...
@dataclass
class ZPOTFSConfig:
    """ZP-OTFS parameters: delay axis M, Doppler axis N, per-subsymbol zero-pad zp_len, DD impulse-pilot position and guards, LMMSE tap cap."""
...
class ZPOTFSTransceiver:
    """ZP-OTFS transceiver: inverse-Zak TX with per-subsymbol zero padding; RX = DD pilot estimation, ZP-tail noise estimate, time-domain sparse LMMSE, Zak recovery (report Sec. 6)."""
